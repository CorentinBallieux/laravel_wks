        ...
        <form action="{{ route('todos.store') }}" method="POST"
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="3"
                        ...
                        class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-gray-900 placeholder:italic"></textarea>
            </div>
